...
class ClienteResourceIT {
     ...
     *
     * @see org.econ.repository.search.ClienteSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Cliente createEntity(EntityManager em) {
        Cliente cliente = new Cliente().nomeCliente(DEFAULT_NOME_CLIENTE).indirizzo(DEFAULT_INDIRIZZO).tipo(DEFAULT_TIPO);
        return cliente;
    }
    ...
    public static Cliente createUpdatedEntity(EntityManager em) {
        Cliente cliente = new Cliente().nomeCliente(UPDATED_NOME_CLIENTE).indirizzo(UPDATED_INDIRIZZO).tipo(UPDATED_TIPO);
        return cliente;
    }
    ...
    void putNewCliente() throws Exception {
        ...
        updatedCliente.nomeCliente(UPDATED_NOME_CLIENTE).indirizzo(UPDATED_INDIRIZZO).tipo(UPDATED_TIPO);
    ...
    void partialUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.tipo(UPDATED_TIPO);
    ...
    void fullUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.nomeCliente(UPDATED_NOME_CLIENTE).indirizzo(UPDATED_INDIRIZZO).tipo(UPDATED_TIPO);
    ...
    void searchCliente() throws Exception {
        ...
        // Initialize the database
        clienteRepository.saveAndFlush(cliente);
        when(mockClienteSearchRepository.search("id:" + cliente.getId())).thenReturn(Stream.of(cliente));
