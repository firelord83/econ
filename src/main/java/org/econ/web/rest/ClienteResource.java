...
import org.econ.repository.ClienteRepository;
import org.econ.repository.search.ClienteSearchRepository;
...
/**
 * REST controller for managing {@link org.econ.domain.Cliente}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ClienteResource {
    ...
    public List<Cliente> searchClientes(@RequestParam String query) {
        ...
        return StreamSupport.stream(clienteSearchRepository.search(query).spliterator(), false).collect(Collectors.toList());
    }
}
